...
import { updateTestAction } from "@/app/admin/tests/edit-actions";
...
function makeDefaultScales(): ScaleDraft[] {
    return [
        {
            code: "D",
            title: "Депресія",
    ...
    const [questions, setQuestions] = useState<QuestionDraft[]>(
        test.questions.length > 0
            ? [...test.questions]
                ...
                .map((question) => ({
                    text: question.text,
                    scaleCode: question.scale?.code ?? "",
                    options:
                        question.answerOptions.length > 0
                            ? mapOptions(question.answerOptions)
                            : makeDefaultOptions(),
                }))
            : [
                {
                ...
                <div className="grid gap-4">
                    ...
                    <label className="grid gap-2">
                        ...
                        <textarea
                            ...
                            className="min-h-28 rounded-2xl border border-black/10 bg-card px-5 py-4 text-sm text-text shadow-sm outline-none transition hover:border-black/20 hover:bg-hover whitespace-pre-line"
